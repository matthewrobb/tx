 ...
 */
function confirmFn(...args: Json[]): EvalResult {
  if (args.length !== 1) {
 ...
 * text as a var.
 */
function promptFn(...args: Json[]): EvalResult {
  if (args.length !== 1) {
 ...
 */
function chooseFn(...args: Json[]): EvalResult {
  if (args.length < 2) {
 ...
 */
export function createInteractiveFunctions(): Map<string, ExprFn> {
 ...
 */
export function createInteractiveEvaluator(): ExpressionEvaluator {
