...
export function parse(input: string): ParseResult {
  ...
  function expect(kind: TokenKind): Token | null {
   ...
   */
  const COMPARE_OPS: Record<string, BinaryOp> = {
    '==': 'eq',
    '!=': 'neq',
    '<': 'lt',
    '<=': 'lte',
  ...
  function parseCompare(): ParseResult {
  ...
  function parseMember(): ParseResult {
  ...
  function parseCallOrPrimary(): ParseResult {
