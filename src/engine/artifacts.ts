 ...
 */
export function artifactSatisfied(epicDir: string, artifact: ArtifactRef): boolean {
 ...
 */
export function allArtifactsSatisfied(epicDir: string, artifacts: ArtifactRef[]): boolean {
 ...
 * @param artifacts - Artifact references to check.
 */
export function missingArtifacts(epicDir: string, artifacts: ArtifactRef[]): ArtifactRef[] {
