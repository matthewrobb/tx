 ...
 */
export function serverJsonPath(twistedRoot: string): string {
 ...
 */
export function writeServerJson(twistedRoot: string, socket: string): void {
 ...
 */
export function deleteServerJson(twistedRoot: string): void {
 ...
 */
export function readServerJson(twistedRoot: string): ServerInfo | null {
  const path = serverJsonPath(twistedRoot);
 ...
 */
export function isDaemonAlive(twistedRoot: string): boolean {
 ...
 */
export function cleanupStale(twistedRoot: string): void {
