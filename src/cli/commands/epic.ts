...
import type { EpicType } from "../../types/index.js";
import type { CliContext } from "../context.js";

export function registerEpicCommands(program: Command, ctx: CliContext): void {
  ...
  program
    ...
    .action((epicName: string, opts: { size: string; rationale: string; timebox?: string; confidence: string }) => {
  ...
  program
    ...
    .action((epicName: string, opts: { type: string }) => {
      const targetType = opts.type as EpicType;
      try {
  ...
  program
    ...
    .action((epicName: string, action: string | undefined, arg: string | undefined) => {
      const location = locateEpic(root, epicName);
      if (!location) {
